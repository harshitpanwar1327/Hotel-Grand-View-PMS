      ...
      <form onSubmit={handleSubmit(onsubmit)} onClick={(e)=>e.stopPropagation()} className="bg-white w-full md:w-2/3 lg:w-1/2 rounded-xl flex flex-col gap-4 p-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            ...
            <input type="text" id="roomNumber" className="w-full p-2 border border-gray-200 rounded-xl focus:outline-none focus-within:border-[#1B2A41] focus-within:ring-1 focus-within:ring-[#1B2A41] transition duration-300" placeholder="Enter room number"
              {...register("roomNumber", { 
          ...
          <div className="flex flex-col gap-1">
            ...
            <select id="roomType" className="w-full p-2 border border-gray-200 rounded-xl focus:outline-none focus-within:border-[#1B2A41] focus-within:ring-1 focus-within:ring-[#1B2A41] transition duration-300" 
              {...register("roomType", { 
          ...
          <div className="flex flex-col gap-1">
            ...
            <input id="pricePerNight" type="number" className="w-full p-2 border border-gray-200 rounded-xl focus:outline-none focus-within:border-[#1B2A41] focus-within:ring-1 focus-within:ring-[#1B2A41] transition duration-300" placeholder="Enter room price"
          ...
          <div className="flex flex-col gap-1">
            ...
            <select id="status" className="w-full p-2 border border-gray-200 rounded-xl focus:outline-none focus-within:border-[#1B2A41] focus-within:ring-1 focus-within:ring-[#1B2A41] transition duration-300" 
              {...register("status", {
        ...
        <div className='flex justify-end gap-3 text-sm'>
          ...
          <button type="submit" className='bg-[#1B2A41] shadow-[#1B2A41]/40 hover:shadow-lg text-white px-4 py-2 rounded-xl hover:opacity-90 transition duration-300 disabled:cursor-not-allowed!' disabled={loading}>{loading ? <ClipLoader size={18} color="#ffffff" /> : "Add Room"}</button>
        </div>
      </form>
    </div>
  )
